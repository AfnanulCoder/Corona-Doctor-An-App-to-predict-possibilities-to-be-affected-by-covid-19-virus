...
public class ConnectFour_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_connect_four_2);
    ...
    void makeEditText(int i, int a)
    {
        ...
        playerNameET[i].setBackground(getDrawable(R.drawable.round_corner_colorful_shape));
    ...
    public void startGame(View view)
    {
        ...
        {
            Intent intent = new Intent(this, ConnectFour_3.class);
    ...
    public void onBackPressed() {
        startActivity(new Intent(ConnectFour_2.this, ConnectFour_1.class));
    }
}
