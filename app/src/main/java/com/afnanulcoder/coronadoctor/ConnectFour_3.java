...
public class ConnectFour_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_connect_four_3);
    ...
    {
        Intent intent = new Intent(this, ConnectFour_1.class);
        startActivity(intent);
    }

    @Override
    public void onBackPressed() {
        startActivity(new Intent(ConnectFour_3.this, ConnectFour_1.class));
    }
}
